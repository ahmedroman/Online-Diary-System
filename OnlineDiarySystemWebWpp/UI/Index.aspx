<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="OnlineDiarySystemWebWpp.UI.Index" %>
    ...
    <div class="mainProfilePage">
        <div class="leftProfileArea">
            <div class="proPic">
                ...
                <div class="afterImgDiv"  runat="server" id="propicDiv">
            ...
            <asp:hyperlink runat="server" id="nameLabel" cssclass="fullButton"></asp:hyperlink>
            ...
            <asp:hyperlink runat="server" id="editProfileLink" text="Edit Profile"
                cssclass="fullButton edit-profile-button"></asp:hyperlink>
        </div>
        <div class="mainProfilePosstArea">
            <div class="profilePostArea">
                ...
                <asp:button runat="server" id="postButton" text="Post" onclick="postButton_Click1"></asp:button>
            </div>
        ...
        <Columns>
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:HyperLink runat="server" 
                        NavigateUrl='<%#String.Format("~/UI/UserProfileUI.aspx?UserId={0}", Eval("UserId")) %>' 
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:HyperLink runat="server" cssClass="dateStyle"  
                        NavigateUrl='<%#String.Format("/UI/CommentUI.aspx?postId={0}",Eval("Id")) %>' 
                        Text='<%#Eval("Time", "{0:MM:HH, dd/MMM/yyyy}") %>'></asp:HyperLink>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField>
                <ItemTemplate>
